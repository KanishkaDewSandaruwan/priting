                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                <a href="">
                                    ...
                                    <?php $count = 0;
                                        $sales = 0;
                                        $viewquery = " SELECT * FROM getorder where status = 'Pending'";
                                ...
                                <ul class="show-notification">
                                    ...
                                    <?php $viewquery = " SELECT * FROM getorder where status = 'Pending'";
                                    $viewresult = mysqli_query($con,$viewquery); 
                                    ...
                                    <li>
                                        <a href="order.php">
                                            <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="<?php echo $image_src; ?>" alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h5 class="notification-user"><?php echo $row3['name']; ?></h5>
                                                <p class="notification-msg"><?php echo $row2['title']; ?></p>
                                                <span class="notification-time"><?php echo $row1['order_date']; ?></span>
                                            </div>
                                        </div>
                                        </a>
                                    </li>
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!">
                                    <img src="../img/logo.jpeg" class="img-radius" alt="User-Profile-Image">
                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li>
                                        <a href="" data-toggle="modal" data-target="#exampleModalPassChange">
