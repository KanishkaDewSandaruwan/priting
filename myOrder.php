  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0 pb-6" id="collections">
        <div class="container">
                 <div class="row  ml-3 " style="margin-top: 15%;">
                            <div class="col-md-12 border border-round">
                              <?php   
                                            $getID = $_SESSION['customer_id'];
                                            $count = 0;
                                            
                                            $viewquery = " SELECT * FROM getorder where customer_id='".$getID."'";
                                            $viewresult = mysqli_query($con,$viewquery); 
                                            ...
                                            <div class="row mt-5" style="padding: 2%;  margin: 1%; color: #00394e; background-color: #f9f6f7">
                                              <h4 style="color:black">Order ID #<?php echo $row1['order_id']; ?></h4>


                                                  <div class="dropdown-divider"></div>
                                                  <div class="col-md-4">
                                                    <p><?php echo $row2['title']; ?></p>
                                                    <p>Rs. <?php echo $row2['price']; ?> | <?php echo $row2['unit']; ?></p>
                                                  ...
                                                  <div class="col-sm-2 mt-5">
                                                    <div class="row">
                                                      <?php if ($row1['payment'] == 'Pending' && $row1['status'] == 'Accepted'){ 
                                                        if ($row1['amount'] != '0') {?>
                                                      <button type="submit" class="btn btn-primary" onclick="window.location.href='pay.php?order_id=<?php echo $row1['order_id']; ?>&total=<?php echo $row1['amount']; ?>'">Pay</button>
                                                    <?php } }?>
                                                    </div>
                                                    <div class="row mt-3">
